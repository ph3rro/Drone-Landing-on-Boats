# - Config file for the asv_sim2-mooring-system component
#
# This should only be invoked by asv_sim2-config.cmake.
#
# To load this component into your project, use:
# find_package(asv_sim2 COMPONENTS mooring-system)
#
# This creates the following targets:
#
#   Component library target                - asv_sim2::asv_sim2-mooring-system
#   Alternative target name                 - asv_sim2::mooring-system
...
# this is discouraged:
#
#   asv_sim2-mooring-system_LIBRARY  - Component library (actually contains asv_sim2::mooring-system)
#
# We will also set asv_sim2-mooring-system_FOUND to indicate that the component was found.
#
################################################################################
...
if(asv_sim2-mooring-system_CONFIG_INCLUDED)
  return()
endif()
set(asv_sim2-mooring-system_CONFIG_INCLUDED TRUE)

if(NOT asv_sim2-mooring-system_FIND_QUIETLY)
  message(STATUS "Looking for asv_sim2-mooring-system -- found version 2.0.0")
endif()
...
# dependencies.
if(asv_sim2-mooring-system_FIND_REQUIRED)
...
# dependencies.
if(asv_sim2-mooring-system_FIND_QUIETLY)
...
if(NOT asv_sim2-mooring-system_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of asv_sim2-mooring-system")
endif()

# --------------------------------

if(NOT TARGET asv_sim2::asv_sim2-mooring-system)
  include("${CMAKE_CURRENT_LIST_DIR}/asv_sim2-mooring-system-targets.cmake")

  # Create a simplified imported target name for the mooring-system library.
  # You can link to this target instead of the mooring-system library.
  add_library(asv_sim2::mooring-system INTERFACE IMPORTED)
  set_target_properties(asv_sim2::mooring-system PROPERTIES
    INTERFACE_LINK_LIBRARIES "asv_sim2::asv_sim2-mooring-system")
...
# Link the mooring-system library to the "requested" target
...
if(NOT gz_requested_components)
  ...
  set_target_properties(asv_sim2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};asv_sim2::asv_sim2-mooring-system")
endif()

set(asv_sim2-mooring-system_LIBRARY asv_sim2::asv_sim2-mooring-system)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(asv_sim2-mooring-system "asv_sim2-mooring-system")
