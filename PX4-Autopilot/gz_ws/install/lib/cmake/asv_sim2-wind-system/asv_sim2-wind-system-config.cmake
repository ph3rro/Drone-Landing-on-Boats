# - Config file for the asv_sim2-wind-system component
#
# This should only be invoked by asv_sim2-config.cmake.
#
# To load this component into your project, use:
# find_package(asv_sim2 COMPONENTS wind-system)
#
# This creates the following targets:
#
#   Component library target                - asv_sim2::asv_sim2-wind-system
#   Alternative target name                 - asv_sim2::wind-system
...
# this is discouraged:
#
#   asv_sim2-wind-system_LIBRARY  - Component library (actually contains asv_sim2::wind-system)
#
# We will also set asv_sim2-wind-system_FOUND to indicate that the component was found.
#
################################################################################
...
if(asv_sim2-wind-system_CONFIG_INCLUDED)
  return()
endif()
set(asv_sim2-wind-system_CONFIG_INCLUDED TRUE)

if(NOT asv_sim2-wind-system_FIND_QUIETLY)
  message(STATUS "Looking for asv_sim2-wind-system -- found version 2.0.0")
endif()
...
# dependencies.
if(asv_sim2-wind-system_FIND_REQUIRED)
...
# dependencies.
if(asv_sim2-wind-system_FIND_QUIETLY)
...
if(NOT asv_sim2-wind-system_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of asv_sim2-wind-system")
endif()

# --------------------------------

if(NOT TARGET asv_sim2::asv_sim2-wind-system)
  include("${CMAKE_CURRENT_LIST_DIR}/asv_sim2-wind-system-targets.cmake")

  # Create a simplified imported target name for the wind-system library.
  # You can link to this target instead of the wind-system library.
  add_library(asv_sim2::wind-system INTERFACE IMPORTED)
  set_target_properties(asv_sim2::wind-system PROPERTIES
    INTERFACE_LINK_LIBRARIES "asv_sim2::asv_sim2-wind-system")
...
# Link the wind-system library to the "requested" target
...
if(NOT gz_requested_components)
  ...
  set_target_properties(asv_sim2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};asv_sim2::asv_sim2-wind-system")
endif()

set(asv_sim2-wind-system_LIBRARY asv_sim2::asv_sim2-wind-system)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(asv_sim2-wind-system "asv_sim2-wind-system")
